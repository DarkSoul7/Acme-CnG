...
public class RequestService {
	...
	public Collection<RequestForm> findRequestKeyWordWithoutApplications(final String keyWord) {
	...
	public Collection<RequestForm> findRequestKeyWordIAppliedOrMine(final String keyWord) {
		Customer principal = customerService.findByPrincipal();
