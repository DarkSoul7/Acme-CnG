...
<display:table name="offers" id="row" requestURI="${RequestURI}"
	...
	<spring:message code="offer.originPlace.address" var="originPlaceAddress" />
	<display:column property="originPlace.address" title="${originPlaceAddress}" />
	
	<spring:message code="offer.originPlace.gpsCoordinates.latitude" var="originPlaceGPSLatitude" />
	<display:column property="originPlace.gpsCoordinates.latitude" title="${originPlaceGPSLatitude}" />
	
	<spring:message code="offer.originPlace.gpsCoordinates.longitude" var="originPlaceGPSLongitude" />
	<display:column property="originPlace.gpsCoordinates.latitude" title="${originPlaceGPSLongitude}" />
	
	<spring:message code="offer.destinationPlace.address" var="destinationPlaceAddress" />
	<display:column property="destinationPlace.address" title="${destinationPlaceAddress}" />
	
	<spring:message code="offer.destinationPlace.gpsCoordinates.latitude" var="destinationPlaceGPSLatitude" />
